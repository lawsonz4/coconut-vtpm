...
INSTALLER_URL=${INSTALLER_URLS["t42"]}
...
NETWORK_LINE="-netdev user,id=net0 -device e1000,netdev=net0"
  ${QEMU} \
    -machine q35 \
...
echo "Disk image written to: ${HDA}"
